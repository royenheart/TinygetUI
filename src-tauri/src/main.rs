...
use tinyget_ui::tinyget::get_list::{softs, __cmd__softs};
use tinyget_ui::utils::{
    long_running_thread, show_item_in_folder, show_main_window, DbusState,
    __cmd__show_item_in_folder,
};
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            tauri::async_runtime::spawn(async move {
                long_running_thread(&app_handle).await
            });
